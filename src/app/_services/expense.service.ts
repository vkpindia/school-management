...
export class ExpenseService {
  ...
  getExpenseTypes() {
    //
    return this._http.get(this._apiUrl + 'setup/getexpensetypes').pipe(
  ...
  getExpenseList() {
    ...
    return this._http.get(this._apiUrl + 'setup/getexpenses').pipe(
      map(this.extractData),
      catchError(this.handleError));
  }
  ...
  getExpenseDetails(id: any): Observable<any> {
    const url = `${this._apiUrl}setup/getexpense?id=${id}`;
   ...
   * @memberof ExpenseService
   */
  saveExpense(ParentRecord: any): Observable<any> {
    // console.log('parentRecord', parentRecord);
    return this._http.post(this._apiUrl + 'setup/addexpenses', ParentRecord)
     .pipe(
       map(this.extractData),
       catchError(this.handleError)
     );
  ...
  updateExpense(id, ParentRecord: any): Observable<any> {
    return this._http.put(this._apiUrl + 'setup/updateexpenses', ParentRecord)
    .pipe(
      map(this.extractData),
      catchError(this.handleError)
    );
  ...
  deleteExpense(id: any): Observable<any> {
    const url = `${this._apiUrl}setup/deleteexpenses?id=${id}`;
