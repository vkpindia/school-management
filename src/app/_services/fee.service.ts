...
export class FeeService {
   ...
   */
  getFeeList() {
    return this._http.get(this._apiUrl + 'accounts/getfees').pipe(
      map(this.extractData),
      catchError(this.handleError));
  }
   ...
   * @memberof FeeService
   */
  getFeeDetails(id: any): Observable<any> {
    const url = `${this._apiUrl}accounts/getfee?id=${id}`;
    return this._http.get(url).pipe(
      map(this.extractData),
      catchError(this.handleError));
  }
   ...
   * @memberof FeeService
   */
  saveFee(ParentRecord: any): Observable<any> {
    // console.log('parentRecord', parentRecord);
    return this._http.post(this._apiUrl + 'accounts/Addfees', ParentRecord)
     .pipe(
       map(this.extractData),
       catchError(this.handleError)
     );
   ...
   * @memberof FeeService
   */
  updateFee(id, ParentRecord: any): Observable<any> {
    return this._http.put(this._apiUrl + 'accounts/updatefees', ParentRecord)
    .pipe(
      map(this.extractData),
      catchError(this.handleError)
    );
  ...
  deleteFee(id: any): Observable<any> {
    const url = `${this._apiUrl}accounts/deletefee?id=${id}`;
